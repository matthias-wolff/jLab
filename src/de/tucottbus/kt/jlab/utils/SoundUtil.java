...
public class SoundUtil implements DdPreferenceConstants
{
  /**
   ...
   *          The preference store to obtain audio play-back preferences from,
   ...
   *         opened!
   */
  public static SourceDataLine getPlaybackDataline
  (
    AudioFormat      iAf,
  ...
  )
  {
    try
    {
      return getPlaybackDataline(iAf,preferenceStore.getString(P_VIS_SNDPLAYDEV));
    }
    catch (NullPointerException e) {}
    return getPlaybackDataline(iAf,(String)null);
  }
}
...
import de.tucottbus.kt.jlab.datadisplays.widgets.AbstractComponent;
...
public abstract class AbstractDataDisplay extends AbstractComponent
{
  ...
  public static final int DRAW_ALL     = 0xFFFF;
	 ...
	 */
	protected ColorManager m_iVcm;

	/**
	 * List of listeners to be notified on DisplayEvents
	 */
	private LinkedList<IDisplayEventListener> m_iDisplayEventListeners;

	/**
	 * List of listeners for information about this display
	 */
	protected LinkedList<IDisplayInfoListener> m_iDisplayInfoListeners;

	// -- CONSTRUCTORS AND STATIC METHODS ----------------------------------------

	/**
	 * Default data display constructor.
	 * 
	 * @param iParent
	...
	) throws DataException 
	{
		...
		m_iVcm = new ColorManager();
		m_iDisplayEventListeners = new LinkedList<IDisplayEventListener>();
		m_iDisplayInfoListeners = new LinkedList<IDisplayInfoListener>();
	...
	/**
	 * Convenience method returning the <code>JlData</code> instance associated
	 * with this display.
   ...
   *          The graphics context to draw on
    ...
    try
    {
      getDisplay().syncExec(new DrawOnRunnable(iGc,iHrc,iVrc,nFlg));
    }
    catch (Throwable e)
    {

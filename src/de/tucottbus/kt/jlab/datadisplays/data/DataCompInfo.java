...
public class DataCompInfo
{
    ...
    catch (DataException e)
    {
      try
      {
        ...
        for (nC = 0; nC < nXC; nC++)
        {
          ...
          if (sType.indexOf(".")<0)
            sType = "de.tucottbus.kt.jlab.datadisplays.components.displays." + sType;
  ...
  public static void autoLayout(DataCompInfo[] aDci)
  {
    ...
    if (aDci.length>=DdUtils.VOP_DEF_VISIBLE_DISPLAYS)
  ...
  public static void oscillogramLayout(DataCompInfo[] aDci)
  {
    ...
    for (int nC=0,nComps=0; nC<aDci.length; nC++)
      if (!aDci[nC].sCompType.equals("String"))
      {
        ...
        aDci[nC].bVisible = nComps<DdUtils.VOP_DEF_VISIBLE_DISPLAYS;
      }
  }
